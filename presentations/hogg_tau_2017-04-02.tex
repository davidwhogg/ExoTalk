...
\author[David W. Hogg (NYU)]{David W. Hogg \textsl{(NYU \& MPIA \& Simons)}\\[1ex]
  \textsl{\footnotesize
    ...
    Dun~Wang~\textsl{(NYU)}}}
\date{Tel Aviv University / 2017 April 2}
...
\begin{frame}
  ...
  \includegraphics<6>[height=\figureheight]{1607.08237/full_sample_plus_cands.pdf}
\end{frame}
...
\begin{frame}
  ...
  ~\hfill
  \includegraphics<1>[height=\figureheight]{1502.04715/figures-linear.pdf}
  \includegraphics<2>[height=\figureheight]{1502.04715/figures-periodic.pdf}
  \includegraphics<3>[height=\figureheight]{1502.04715/figures-de-trended.pdf}
  \includegraphics<4>[height=\figureheight]{1502.04715/figures-folded.pdf}
  \includegraphics<5>[height=\figureheight]{1502.04715/figures-candidates.pdf}
\end{frame}
...
\begin{frame}
  \frametitle{Long-period planets {\footnotesize (Foreman-Mackey \etal, arXiv:1607.08237)}}
  \begin{itemize}
  \item If a planet has such a long orbit that it transits only once,
    ...
    \item must model other kinds of ``data events''
    \end{itemize}
  \item Find \emph{2.0$\pm$0.7 long-period planets per star}.
    \begin{itemize}
    \item periods 2 to 25\,yr
    \item radii 0.2 to 2\,$R_{\mathrm Jup}$
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Long-period planets {\footnotesize (Foreman-Mackey \etal, arXiv:1607.08237)}}
  ~\hfill
  \includegraphics<1>[height=\figureheight]{1607.08237/model_comp.pdf}%
  \includegraphics<2>[height=\figureheight]{1607.08237/full_sample_plus_cands.pdf}%
  \includegraphics<3>[height=\figureheight]{1607.08237/completeness.pdf}%
\end{frame}
