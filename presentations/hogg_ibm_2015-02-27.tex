...
\begin{frame}
  ...
  \item Earth-like planets are plentiful in our Galaxy
    \begin{itemize}
    \item few solar systems ``look like'' ours
...
\begin{frame}
  ...
  \includegraphics<7>[height=\figureheight]{1502.04715/figures-completeness.pdf}
  \includegraphics<8>[height=\figureheight]{1502.04715/figures-candidates.pdf}
\end{frame}
