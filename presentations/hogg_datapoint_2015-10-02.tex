...
\title{Finding planets around other stars \\ with methods from data science}
...
{\textsl{DataPoint} / 2015 October 02}}
...
\begin{frame}
  \frametitle{an Earth-like planet transit signal}
  \begin{itemize}
...
\begin{frame}
  ...
  ~\hfill
  \includegraphics<1>[height=\figureheight]{1406.3020/results-radius.pdf}
  \includegraphics<2>[width=0.8\textwidth]{1406.3020/figures-comparison.pdf}
\end{frame}
