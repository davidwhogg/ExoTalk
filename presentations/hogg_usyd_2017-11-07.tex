...
\title{Finding planets in \kepler\ and K2 data}
\author[David W. Hogg (NYU)]{David W. Hogg \textsl{(NYU \& MPIA \& Flatiron)}\\[1ex]
  \textsl{\footnotesize
    in collaboration with:
    Dan~Foreman-Mackey~\textsl{(Flatiron)},
    Bernhard~Sch\"olkopf~\textsl{(MPI-IS)},
    Dun~Wang~\textsl{(NYU)}}}
\date{Hunstead Lecture / 2017-11-07}
