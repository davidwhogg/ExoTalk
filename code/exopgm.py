...
pgm.add_node(daft.Node("exopop", r"exopop", 1.8, 3, aspect=2.0))
pgm.add_node(daft.Node("starpop", r"starpop", 3, 3, aspect=2.0))
...
pgm2.render()
pgm2.figure.savefig("onecause.pdf")
pgm2.figure.savefig("onecause.png", dpi=150)
